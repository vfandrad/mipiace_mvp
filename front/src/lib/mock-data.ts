    ...
    order_items: [
      {
        ...
        quantity: 1,
        flavors: ["Pistache", "Doce de Leite"],
        accompaniments: ["Cascão Artesanal"],
      },
      {
        id: "1b",
        products: {
    ...
    order_items: [
      {
        ...
        quantity: 1,
        flavors: ["Ninho com Nutella", "Café Robusta"],
        accompaniments: ["Cascão Artesanal", "Cascão Artesanal"],
      },
    ],
    total_price: 56.0,
    ...
    order_items: [
      {
        ...
        quantity: 2,
        flavors: ["Limão Siciliano", "Morango Zero Lactose"],
        accompaniments: [],
      },
      {
        id: "3b",
    ...
    order_items: [
      {
        ...
        quantity: 3,
        flavors: ["Fior di Latte Zero Açúcar", "Iogurte com Amarena"],
        accompaniments: [],
      },
    ],
    total_price: 90.0,
    ...
    order_items: [
      {
        ...
        quantity: 1,
        flavors: ["Paçoquinha", "Chocolate Zero Açúcar"],
        accompaniments: [],
      },
    ],
    total_price: 50.0,
    ...
    order_items: [
      {
        ...
        flavors: ["Maracujá", "Frutas Vermelhas Zero Lactose"],
        accompaniments: ["Cascão Artesanal"],
      },
    ],
    total_price: 63.0,
...
export const mockSalesData: SalesData[] = [
  { date: "2024-01-20", total: 2450.0, orders: 52 },
  { date: "2024-01-21", total: 2880.0, orders: 61 },
  { date: "2024-01-22", total: 2120.0, orders: 45 },
  { date: "2024-01-23", total: 3150.0, orders: 68 },
  { date: "2024-01-24", total: 3590.0, orders: 76 },
  { date: "2024-01-25", total: 4100.0, orders: 89 },
  { date: "2024-01-26", total: 3850.0, orders: 82 },
];
